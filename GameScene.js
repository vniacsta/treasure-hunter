...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Creating the for loops to create the grid
    ...
    // Creating the coins from the grid created above  
  ...
  update() {
    ...
    this.add.text(195, 487, ' ' + playerCoins + '  ', {
        font: '16px Helvetica',
        fill: '#000000',
        padding: {
          x: 6,
    ...
    this.add.text(430, 487, ' ' + compCoins + '  ', {
        font: '16px Helvetica',
        fill: '#000000',
        padding: {
          x: 6,
